            ...
            <n-space vertical>
              ...
              <n-tabs type="line">
                ...
                <n-tab-pane name="raw" tab="Raw JSON">
                  <n-code language="json">{{ formatJson(bookStore.$state) }}</n-code>
                </n-tab-pane>
              </n-tabs>
            </n-space>
          </n-card>
          ...
          <n-card title="Счета">
            <n-space vertical>
              ...
              <n-tabs type="line">
                ...
                <n-tab-pane name="raw" tab="Raw JSON">
                  <n-code language="json">{{ formatJson(accountStore.$state) }}</n-code>
                </n-tab-pane>
              </n-tabs>
            </n-space>
          </n-card>
          ...
          <n-card title="Транзакции">
            <n-space vertical>
              ...
              <n-tabs type="line">
                ...
                <n-tab-pane name="raw" tab="Raw JSON">
                  <n-code language="json">{{ formatJson(transactionStore.$state) }}</n-code>
                </n-tab-pane>
              </n-tabs>
            </n-space>
          </n-card>
          ...
          <n-card title="Категории">
            <n-space vertical>
              ...
              <n-tabs type="line">
                ...
                <n-tab-pane name="raw" tab="Raw JSON">
                  <n-code language="json">{{ formatJson(categoryStore.$state) }}</n-code>
                </n-tab-pane>
              </n-tabs>
            </n-space>
          </n-card>
