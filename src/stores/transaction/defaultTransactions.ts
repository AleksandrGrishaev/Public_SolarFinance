...
export const defaultTransactions: Transaction[] = [
  ...
  // 3 ТРАНЗАКЦИИ В ОДИН ДЕНЬ (10-03-2025)
  {
    id: "family_day2_1",
    date: new Date("2025-03-10"),
    amount: -12800,
  ...
  },
  {
    ...
    responsibleOwnerIds: ["user_1", "user_2"],
    distributionRules: [
      { ownerId: "user_1", percentage: 40 },
      { ownerId: "user_2", percentage: 60 }
    ],
    bookId: "family",
    createdAt: new Date("2025-03-10"),
    updatedAt: new Date("2025-03-10")
  ...
  // 5 ТРАНЗАКЦИЙ В ОДИН ДЕНЬ (15-03-2025)
  {
    id: "family_day3_1",
    date: new Date("2025-03-15"),
    amount: -22400,
  ...
  },
  {
    ...
    responsibleOwnerIds: ["user_1", "user_2"],
    distributionRules: [
      { ownerId: "user_1", percentage: 100 },
      { ownerId: "user_2", percentage: 0 }
    ],
    bookId: "family",
    createdAt: new Date("2025-03-15"),
    updatedAt: new Date("2025-03-15")
  },
  {
    ...
    responsibleOwnerIds: ["user_1", "user_2"],
    distributionRules: [
      { ownerId: "user_1", percentage: 75 },
      { ownerId: "user_2", percentage: 25 }
    ],
    bookId: "family",
    createdAt: new Date("2025-03-15"),
    updatedAt: new Date("2025-03-15")
  },
  {
    ...
    responsibleOwnerIds: ["user_1", "user_2"],
    distributionRules: [
      { ownerId: "user_1", percentage: 20 },
      { ownerId: "user_2", percentage: 80 }
    ],
    bookId: "family",
    createdAt: new Date("2025-03-15"),
    updatedAt: new Date("2025-03-15")
